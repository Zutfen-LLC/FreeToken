...
class UserReply(BaseFrontendMsg):
    ...
    gpu_mem_bytes: int = 0
    # GPU-measured prefill for this request (see message.tokenizer.PrefillMeasurement),
    # present on the first sampled reply only, and only under FREETOKEN_INSTRUMENT_PREFILL.
