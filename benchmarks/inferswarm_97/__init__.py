"""Issue #97 (InferSwarm): Gemma v4 physical calibration producer.

Executes the accepted issue #95 v4 methodology
(inferswarm @ e12a6e3d5589044bace0c9555c0d364fb57a6229,
docs/qualification/gemma4-12b-it-v4/) on the frozen physical topology:
...
The execution harness is the accepted #88 producer path, renamed only to bind
the v4 evidence identity.  It adds ZERO model/execution math.
...
Execution-branch discipline (issue #97 Phase A): this package and its
...
# Accepted v4 methodology identity (inferswarm PR #96 merge).
