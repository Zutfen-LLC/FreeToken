"""#97 v4 remote last-stage service (inferswarm03) over the accepted R4 wire.
    ...
    try:
        ...
        while True:
            ...
            if header["operation"] == "prefill" and capture_step is not None:
                from benchmarks.inferswarm_97 import executor_rule_proof
