"""#97 v4 reference runner: RTX 3090 canonical reference execution.

Runs the frozen c95-*/p95-* case manifests through the accepted execution path
and retains the v4 semantic evidence per case:
